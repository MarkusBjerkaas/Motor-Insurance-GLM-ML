...
```
 ...
 M src_asserts/residual_diagnostics_asserts.py
 M src_core_glm/residual_diagnostics.py
...
```
 ...
 glm_pricing_models.ipynb                    | 485 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++------------------
 glm_pricing_severity.ipynb                  | 820 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-----------------------------------------
 src_asserts/residual_diagnostics_asserts.py |  23 +++--
 src_core_glm/residual_diagnostics.py        |   9 +-
 6 files changed, 1022 insertions(+), 342 deletions(-)
```
