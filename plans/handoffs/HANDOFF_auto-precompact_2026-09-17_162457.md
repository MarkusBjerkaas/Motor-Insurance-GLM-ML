...
```
 ...
 M pyproject.toml
 M uv.lock
?? plans/handoffs/HANDOFF_auto-precompact_2026-09-17_161302.md
?? src/abess_diagnostics.py
?? src/phase_2/interactions.py
?? src/phase_2/secondary_blocks.py
?? src/phase_2/sensitivities.py
```

## Uncommitted Changes

```
 glm_pricing_models.ipynb | 863 +++++++++++++++++----------------------------------------------------------------------------------------------------------------------------------
 glm_pricing_models.py    | 851 +++++++++++++++---------------------------------------------------------------------------------------------------------------------------------
 pyproject.toml           |   1 +
 uv.lock                  |  60 +++++++++++
 4 files changed, 246 insertions(+), 1529 deletions(-)
```
