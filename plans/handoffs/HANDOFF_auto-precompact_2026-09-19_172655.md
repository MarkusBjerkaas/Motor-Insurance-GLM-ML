...
```
 ...
 M ml_pricing.ipynb
 M ml_pricing.py
 M src_asserts/common_glm_asserts.py
 ...
 M tweedie.py
 M tweedie_plan.md
?? plans/handoffs/HANDOFF_auto-precompact_2026-09-19_163726.md
?? plans/handoffs/HANDOFF_auto-precompact_2026-09-19_171248.md
?? src_core_glm/selection_report.py
...
```
 analysis.ipynb                         |   2 +-
 glm_pricing_models.ipynb               |   4 +-
 glm_pricing_severity.ipynb             |  11 ++++--
 ml_pricing.ipynb                       |  17 +++++++++
 ml_pricing.py                          |   4 ++
 src_asserts/common_glm_asserts.py      |  18 +++++++++
 src_asserts/tweedie_asserts.py         |  18 ---------
 src_core_glm/model_selection.py        | 219 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++--------------------------------------------
 src_frequency/frequency_diagnostics.py |  22 +++++------
 src_ml/catboost_pricing.py             |   2 +-
 tweedie.ipynb                          | 333 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++---------------------
 tweedie.py                             | 321 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++------------------------------------------------
 tweedie_plan.md                        |   5 +++
 13 files changed, 712 insertions(+), 264 deletions(-)
```
