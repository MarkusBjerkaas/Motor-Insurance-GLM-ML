...
samlet i ``src/asserts/`` slik at pakken og importlinjene kan slettes ved
...
from src.core_glm.model_data import TRAIN_YEARS, assert_development_years  # noqa: F401
